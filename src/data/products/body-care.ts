...
export const bodyCareProducts: ProductV2[] = [
    // --- BODY SCRUBS ---
    {
        ...
        short_description: "Exfoliating scrub.", long_description: "Exfoliating scrub for soft, glowing skin.", base_price: 599, rating: 4.8, reviews_count: 90, tags: [],
        images: [{ type: "hero", url: "/images/products/prod_deep_repair_mask.png", alt_text: "Body Scrub" }], seo: { meta_title: "Body Scrub", meta_description: "", meta_keywords: [] },
    ...
    },
    {
        ...
        short_description: "Tesu Flower essence.", long_description: "Unique formulation with Tesu flower for skin health.", base_price: 599, rating: 4.7, reviews_count: 80, tags: [],
        images: [{ type: "hero", url: "/images/products/prod_deep_repair_mask.png", alt_text: "Body Scrub" }], seo: { meta_title: "Body Scrub", meta_description: "", meta_keywords: [] },
    ...
    // --- SOAPS ---
    {
        ...
        images: [{ type: "hero", url: "/images/products/prod_deep_repair_mask.png", alt_text: "Soap" }], seo: { meta_title: "Soap", meta_description: "", meta_keywords: [] },
    ...
    },
    {
        ...
        short_description: "Moisturizing.", long_description: "Moisturizing with goat milk and Ayurvedic herbs.", base_price: 249, rating: 4.8, reviews_count: 150, tags: [],
        images: [{ type: "hero", url: "/images/products/prod_deep_repair_mask.png", alt_text: "Soap" }], seo: { meta_title: "Soap", meta_description: "", meta_keywords: [] },
    ...
    },
    {
        ...
        short_description: "Citrus fresh.", long_description: "Refreshing citrus soap for daily use.", base_price: 199, rating: 4.7, reviews_count: 180, tags: [],
        images: [{ type: "hero", url: "/images/products/prod_deep_repair_mask.png", alt_text: "Soap" }], seo: { meta_title: "Soap", meta_description: "", meta_keywords: [] },
