...
export const lipMakeupProducts: ProductV2[] = [
    // --- LIP SCRUBS ---
    {
        ...
        images: [{ type: "hero", url: "/images/products/prod_deep_repair_mask.png", alt_text: "Lip Scrub" }], seo: { meta_title: "Lip Scrub", meta_description: "", meta_keywords: [] },
    ...
    // --- LIP BALMS ---
    {
        ...
        short_description: "Daily moisture.", long_description: "Daily moisturizing balm.", base_price: 199, rating: 4.8, reviews_count: 200, tags: [],
        images: [{ type: "hero", url: "/images/products/prod_volumizing_serum.png", alt_text: "Lip Balm" }], seo: { meta_title: "Lip Balm", meta_description: "", meta_keywords: [] },
    ...
    // --- LIP SERUMS ---
    {
        ...
        short_description: "Deep repair.", long_description: "Deep repair for severely dry lips.", base_price: 399, rating: 4.7, reviews_count: 60, tags: [],
        images: [{ type: "hero", url: "/images/products/prod_volumizing_serum.png", alt_text: "Lip Serum" }], seo: { meta_title: "Lip Serum", meta_description: "", meta_keywords: [] },
    ...
    // --- LIP GLOSS ---
    {
        ...
        images: [{ type: "hero", url: "/images/products/prod_volumizing_serum.png", alt_text: "Lip Gloss" }], seo: { meta_title: "Lip Gloss", meta_description: "", meta_keywords: [] },
    ...
    },
    {
        ...
        short_description: "Golden shimmer.", long_description: "Lip gloss with gold shimmer.", base_price: 399, rating: 4.8, reviews_count: 60, tags: [],
        images: [{ type: "hero", url: "/images/products/prod_volumizing_serum.png", alt_text: "Lip Gloss" }], seo: { meta_title: "Lip Gloss", meta_description: "", meta_keywords: [] },
    ...
    // --- LIPSTICK ---
    {
        ...
        short_description: "Matte herbal.", long_description: "Long lasting herbal lipstick.", base_price: 599, rating: 4.7, reviews_count: 40, tags: [],
        images: [{ type: "hero", url: "/images/products/prod_volumizing_serum.png", alt_text: "Lipstick" }], seo: { meta_title: "Lipstick", meta_description: "", meta_keywords: [] },
    ...
    {
        id: "EC-MA-001", sku: "EC-MA-M-001", slug: "herbal-eye-mascara", name: "Herbal Eye Mascara", brand: "BeautyBeet", status: "published", category: "Eye Care", category_code: "EC", subcategory: "Eye Care", subcategory_code: "EC",
        ...
        images: [{ type: "hero", url: "/images/products/prod_volumizing_serum.png", alt_text: "Mascara" }], seo: { meta_title: "Mascara", meta_description: "", meta_keywords: [] },
