...
const NAV_ITEMS = [
    ...
    { label: "Promo Stripe", icon: Activity, path: "/admin/promo-stripe" },
    ...
    { label: "Targeted Solutions", icon: Sparkles, path: "/admin/targeted-solutions" },
    { label: "Routine Kits", icon: Package, path: "/admin/routine-kits" },
