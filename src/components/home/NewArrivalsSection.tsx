        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {newProducts.map((product) => (
            ...
            >
              ...
              <div className="relative aspect-square bg-gradient-to-br from-accent/5 to-primary/5 flex items-center justify-center">
                ...
                <div className="absolute top-3 left-3">
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-bold uppercase bg-accent text-accent-foreground flex items-center gap-1">
