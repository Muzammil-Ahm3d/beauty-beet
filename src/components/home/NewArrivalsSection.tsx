...
import { Heart, ShoppingBag, ArrowRight, Sparkles, Star } from "lucide-react";
            ...
            >
              ...
              <div className="h-[280px] w-full relative bg-muted overflow-hidden">
                ...
                <div className="absolute top-3 left-3 z-10">
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-bold uppercase bg-accent text-accent-foreground flex items-center gap-1 shadow-sm">
              ...
              <div className="p-4 flex flex-col flex-grow">
                ...
                {/* Rating - Pushed to bottom if needed or just part of flow. Using flex-grow on content above if we wanted footer alignment, but simple flow is usually fine for height. */}
